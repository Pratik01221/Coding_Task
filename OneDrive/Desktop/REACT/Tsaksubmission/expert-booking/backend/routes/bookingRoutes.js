...
const { createBooking, getBookingsByEmail, updateBookingStatus, getUserBookings, getExpertBookings, getExpertEarnings } = require('../controllers/bookingController');
...
router.get('/expert/:expertId/earnings', protect, getExpertEarnings);

// GET /bookings/expert/:expertId
router.get('/expert/:expertId', protect, getExpertBookings);
